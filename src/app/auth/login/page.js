      ...
      <div className="flex flex-col justify-center items-center gap-6">
        ...
        <form className="w-full max-w-[300px] lg:max-w-[440px]">
          <div className="flex flex-col">
            ...
            <span>
              <Link href="/?auth=forgotpassword" className="flex flex-col justify-end items-end text-dart hover:underline hover:brightness-105 transition-all text-[14px]">
                Forgot Password?
              </Link>
            </span>
            
            <Link href="/home" className=" flex transition-all mt-[35px]" shallow>
