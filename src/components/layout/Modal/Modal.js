...
export default function Modal({
  ...
  return (
    <div className="modal-bg fixed inset-0 flex justify-center items-center z-30 bg-ecx-grey/50">
      <div className="modal relative w-[90%] h-[55%] max-w-[390px] lg:max-w-[670px] max-h-[520px] lg:max-h-[670px] px-6 py-8 bg-white rounded-[24px] flex flex-col items-center gap-[36px]">
