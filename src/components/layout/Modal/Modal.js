...
export default function Modal({ children }){
    ...
    return(
        <div className="fixed inset-0 flex justify-center items-center z-100 bg-[#E1E1E180]" scroll={false}>
        <div className="w-[300px] lg:w-[600px] p-8 bg-white rounded-[24px] shadow-lg h-[450px]  lg:h-[500px] relative">

      {/* <LinkClipArt shrink className="-rotate-[28deg] -top-[55px] -left-[48px]  text-[140px] !z-[-1] " variant="ruby" /> */}
